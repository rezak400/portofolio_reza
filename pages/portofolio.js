                ...
                <a target="_blank">
                    < div>
                        <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                            <img class="lg:h-48 md:h-36 w-full object-cover object-center text-white" src={work.image} alt="loading gambar" />
                            <div class="p-6 bg-white">
                                ...
                                <h1 class="title-font text-lg font-medium text-gray-900 mb-3">{work.title}</h1>
