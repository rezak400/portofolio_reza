  ...
  res.json({
    data: [
      ...
      },
      {
        ...
        category: ["Front-End"],
        content:
          "E - Commerce static website made all by myself, UI/UX, pure native javascript",
        image:
          "https://github.com/rezak400/bootcamp_etech/blob/master/assets/images/landing.png?raw=true",
      ...
      },
      {
        ...
        content:
          "My first MERN stack website project, you can create blog for free in here :D",
        image:
